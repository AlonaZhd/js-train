...
class AudioBook {
     ...
     */
    describe() {
        return `Аудіокнига: '${this.title}', автор: '${this.author}', колір тривалість: '${this.audioLength}'`;
    }
}
...
// Аудіокнига: 'Назва аудіокниги', автор: 'Автор аудіокниги ', колір тривалість: '5 годин'
