...
class HoneyDecorator {
    ...
    // Getter для price розраховує загальну вартість напою, враховуючи базову вартість напою і додаткову вартість меду, яку за замовчуванням встановлюємо на 0.5, і множимо на this.amount.
    get price() {
...
// Приготування Чай, з 2 г меду з медом
