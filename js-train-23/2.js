...
// Group { name: 'Електроніка' } Group { name: 'Книги' } Group { name: 'Електроніка' }
// true
// Продукт: Ноутбук, Група: Електроніка
// Продукт: Навушники, Група: Електроніка
// Продукт: Воно, Група: Книги
// Продукт: Смартфон, Група: Електроніка
// true
// [
//   Product { name: 'Ноутбук', group: Group { name: 'Електроніка' } },
//   Product { name: 'Навушники', group: Group { name: 'Електроніка' } },
//   Product { name: 'Смартфон', group: Group { name: 'Електроніка' } }
// ]
